// ORIJINAL OFFLINE BOOSTRECEIVER YEDEGI - MULTIPLAYER DÖNÜŞÜM ÖNCESİ
// Bu dosya güvenlik amaçlı oluşturulmuştur.

using System.Collections;
using UnityEngine;

public class BoostReceiver_Original_Backup : MonoBehaviour
{
